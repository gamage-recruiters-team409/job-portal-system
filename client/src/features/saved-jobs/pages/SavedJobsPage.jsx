 ...
 * @description Saved Jobs page — matches the High-Fidelity UI Design:
 * search bar, Card/List view toggle, and an empty state illustration
 * when no jobs are saved.
 */
    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          message="Jobs you bookmark will show up here so you can find them again later."
        />
      ) : view === 'card' ? (

      ...
      <div className="relative max-h-[90vh] w-full max-w-md overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl sm:p-8">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            ...
            <strong className="font-semibold text-blue-600">{applicantName || 'this candidate'}</strong> for the{' '}
            <strong className="font-semibold text-blue-600">{jobTitle || 'selected'}</strong> position?
          </p>
          ...
          <div className="mt-5 flex w-full items-center gap-3 rounded-xl border border-emerald-200 bg-emerald-50/80 p-4 text-left text-sm text-emerald-900">
            ...
            <span>
              The applicant status will be updated to <strong className="font-semibold text-emerald-950">&quot;Shortlisted&quot;</strong>.
            </span>
          </div>

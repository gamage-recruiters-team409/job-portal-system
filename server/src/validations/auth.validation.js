 ...
 *
 * Zod 4 note: this project uses Zod 4, so custom messages go through the
 * `error` param (Zod 3's `required_error`/`invalid_type_error` are not used).
 * Chained validators (`.min`, `.max`, `.email`) set their own messages.
 */

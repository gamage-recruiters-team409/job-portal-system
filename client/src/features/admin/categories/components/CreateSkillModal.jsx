/**
 * @file CreateSkillModal.jsx
 * @description Modal for creating a new skill under a category in the Admin portal.
...
import { createSkill } from '../../../../services/adminCategorySkill.service';

const CreateSkillModal = ({ isOpen, categories = [], defaultCategoryId = '', onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const msg =
        err.response?.data?.message || err.message || 'Failed to create skill.';
      setError(msg);
      toast.error(msg);
    } finally {
      setLoading(false);
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-medium text-slate-500 mt-0.5">
                Register a new specialized skill under a domain category.
              </p>
            </div>
          </div>
          <button

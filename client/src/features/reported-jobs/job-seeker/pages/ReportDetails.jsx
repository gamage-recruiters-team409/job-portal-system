...
const REPORT = {
  ...
  reportedDate: 'Jul 22, 2026',

  status: 'under_review',

  job: {
    title: 'Online Data Entry Job-1042',
  ...
  reason: 'Requesting Payment',

  description:
    'They asked me to pay a $45 registration fee before my first shift. Felt like a scam.',
};
    ...
    <div className="mx-auto max-w-4xl p-8">
      ...
      <div className="mt-6 space-y-6">
        <Section title="Report information">
          ...
          <InfoRow label="Reported date" value={REPORT.reportedDate} />
        ...
        <Section title="Job information">
          <InfoRow label="Job title" value={REPORT.job.title} />

          <InfoRow label="Company" value={REPORT.job.company} />

          <InfoRow label="Location" value={REPORT.job.location} isLast />
        </Section>
        ...
        <Section title="Report reason">
          ...
          <div className="pt-4">
            ...
            <p className="mt-2 pl-4 text-sm italic text-gray-700">"{REPORT.description}"</p>
          </div>
        </Section>
